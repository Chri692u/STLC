...
/* package lambdaCalc-0.1.0.0 */
#ifndef VERSION_lambdaCalc
#define VERSION_lambdaCalc "0.1.0.0"
#endif /* VERSION_lambdaCalc */
#ifndef MIN_VERSION_lambdaCalc
#define MIN_VERSION_lambdaCalc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lambdaCalc */
...
#define CURRENT_COMPONENT_ID "lambdaCalc-0.1.0.0-inplace-lambdaCalc"
